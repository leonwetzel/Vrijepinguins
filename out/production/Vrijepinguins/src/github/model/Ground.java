...
/**
 * Public abstract class github.model.Ground.
 * This abstract class implements from interface github.model.Area.
 */
public abstract class Ground implements Area
{
	...
	//The ground's github.model.Location.
	protected AreaLocation areaLocation;

    /**
     * Constructor for a github.model.Ground object
     * @param field
     * @param areaLocation
     */
