...
/**
 * 
 * Public class vrijepinguins.model.Druids for Vossen & Konijnen
 * This druid is a human, therefore he should not extend the superclass vrijepinguins.model.Animal.
 *
 * vrijepinguins.model.Druids can't breed, nor can they die. Their only purpose is to kill all that
...
public class Druids implements Actor
{
	...
	private int spells;
	private int[] fox, rabbit,penguin;
    ...
    /**
     * Find targets
     * @return vrijepinguins.model.Location
     */
